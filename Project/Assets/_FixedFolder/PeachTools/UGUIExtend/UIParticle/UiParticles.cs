...
namespace UiParticles {
	...
	public class UiParticles : MaskableGraphic {
		...
		/// <summary>
		/// 粒子系统渲染模式(billboard, strechedBillobard)
		/// </summary>
		...
		/// 设置有贴图动画的UV
		/// </summary>
		/// <param name="particle">目标粒子</param>
		/// <param name="timeAlive">生命周期</param>
		/// <param name="uvs"></param>
		private void EvaluateTexturesheetUVs (ParticleSystem.Particle particle, float timeAlive, Vector2[] uvs) {
			...
			int totalFramesCount = textureAnimator.numTilesY * textureAnimator.numTilesX;
		...
		/// <summary>
		/// 在展开的广告牌模式下评估粒子的大小和旋转
		/// </summary>
		/// <param name="particle">粒子</param>
		/// <param name="timeAlive01">当前生命时间百分比[0,1]范围</param>
		/// <param name="size3D">粒子大小</param>
		/// <param name="rotation">粒子轴向</param>
